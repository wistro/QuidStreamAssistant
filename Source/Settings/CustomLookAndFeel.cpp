...
void CustomLookAndFeel::setupColours()
{
  ...
  setColour (TextEditor::highlightedTextColourId,
             findColour (defaultHighlightedTextColourId));
  ...
  setColour (TextPropertyComponent::backgroundColourId,
             findColour (widgetBackgroundColourId));
  ...
  setColour (BooleanPropertyComponent::backgroundColourId,
             findColour (widgetBackgroundColourId));
  setColour (ToggleButton::tickDisabledColourId, Colour (0xffa9a9a9));
  setColour (ToggleButton::tickColourId,
            findColour (defaultButtonBackgroundColourId).withMultipliedBrightness(1.3f));
  setColour (CodeEditorComponent::backgroundColourId, findColour (secondaryBackgroundColourId));
  setColour (CodeEditorComponent::lineNumberTextId,
             findColour (codeEditorLineNumberColourId));
  ...
  setColour (TreeView::selectedItemBackgroundColourId,
