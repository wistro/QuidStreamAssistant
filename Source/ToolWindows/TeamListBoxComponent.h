...
class TeamListBoxComponent  : public Component,
                public TableListBoxModel
{
public:
  TeamListBoxComponent();
  TeamListBoxComponent( StringArray prevTeams );
  ~TeamListBoxComponent();
...
private:
  ...
  {
  public:
    ToggleBoxCustomComponent (TeamListBoxComponent& td) : owner (td)
    {
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TeamListBoxComponent)
};
